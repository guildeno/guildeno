import { gray, cyan, yellow, red, bold, italic } from "colorette";
...
export function logger({
    ...
    function log(level: LogLevels, ...args: many[]) {
    ...
    function debug(...args: many[]) {
        log(LogLevels.Debug, ...args);
    }

    function info(...args: many[]) {
        log(LogLevels.Info, ...args);
    }

    function warn(...args: many[]) {
        log(LogLevels.Warn, ...args);
    }

    function error(...args: many[]) {
        log(LogLevels.Error, ...args);
    }

    function fatal(...args: many[]) {
